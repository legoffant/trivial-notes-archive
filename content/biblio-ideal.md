Title: Bibliothèque idéale pour ingénieur système autodidacte (STEM)
...
Des élements introductifs aux maths en passant par des ouvrages de référence tels que les Bourbakis, cette société secrète de mathématicien français. Un part importante sur la logique est initié avec Aristote. L'oeuvre d'Isaac Newton Principia est à l'étude.

* Qu'est-ce que les mathématiques ? Une introduction élémentaire aux idées et aux méthodes; H.Robbins
* Les six premiers livres des Eléments d'Euclide; Oliver Byrne
* Recoltes et semailles; Alexandre Grothedieck
* Elements de mathématiques; N.Bourbaki
* Le fascinant nombre pi; J-P Delahaye
* Gödel, Escher, Bach; D. Hofstadter
* Organon, Aristote
* Les cours de mathématiques; Ramis, Deschamps, Odoux
* Principia - Principes mathématiques de la philosophie naturelle; I. Newton


### Ingénierie

* Les Machines 1876, E. Collignon
* L'art de l'ingenieur : Constructeur, entrepreneur, inventeur; Antoine Picon
* Et soudain apparut l'inventeur; Guenrich Altshuller
...
* Automatique; Granjon
* Electrotechnique base de l'électricité; M. Jufer, Y. Perriard
* Précis de métallurgie; J.Barralis, G.Maeder
* Mécanique des structures; F. Voldoire, Y. Bamberger
* Procédés de soudage; Klas Weman
* Aide-mémoire de pneumatique industrielle; J-R Viloria
* Choix des matériaux en conception mécanique; M F. Ashby
* Guide du calcul en mécanique; D.Spenlé, R.Gourhant
* Guide du technicien en productique; A.Chevalier, J.Bohan
* Simulation numérique en mécanique des fluides. 2e édition; P.Traoré
* Raspberry Pi 4 - Exploitez tout le potentiel de votre nano-ordinateur; F. Mocq
* Arduino le guide complet - Une référence pour ingénieurs, techniciens et bricoleurs; J-M Hughes
* Fab Lab Revolution Field Manual; NIGGLI Collectif
* Mémo Formulaire: Calculs scientifiques fondamentaux; Y. Deplanche, C.Hazard

* Practical Robotics in C++: Build and Program Real Autonomous Robots Using Raspberry Pi; L. Brombach
* Principles of Composite Material Mechanics (Mechanical Engineering) 4th Edition; R. Gibson
* Engineers' Practical Databook: A Technical Reference Guide for Students and Professionals; J. Smith
* The Book of Forces; Metin Bektas
* Mechanical Engineering for Makers: A Hands-on Guide to Designing and Making Physical Things; B.Bunnell
* Practical Electronics for Inventors, Fourth Edition; Paul Scherz
* Manual of Engineering Drawing; Colin H. Simmons
* Robotics: Everything You Need to Know About Robotics from Beginner to Expert; P. Mckinnon
* Internal Combustion Engines; Ganesan
* Engineering Fundamentals: An Introduction to Engineering; S. Moaveni
* Machinery's Handbook Toolbox; E. Oberg
* Marks' Standard Handbook for Mechanical Engineers, 12th Edition; Ali Sadegh, William Worek
* Fundamentals of Astrodynamics; R. Bate
* NASA Systems Engineering Handbook; NASA
* Schaum's Outline of Advanced Mathematics for Engineers and Scientists; M. Spiegel
* Mathematical Methods for Physics and Engineering: A Comprehensive Guide; Riley, Hobson, Bence
* Advanced Engineering Mathematics, 10Th Ed; E. Kreyszig
