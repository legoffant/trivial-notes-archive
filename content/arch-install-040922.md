...
### Système de base
```
pacstrap /mnt base linux linux-firmware git vim intel-ucode ntp
```
...
```
virt-manager qemu qemu-arch-extra edk2-ovmf bridge-utils dnsmasq vde2 openbsd-netcat
```
...
GRUB_CMDLINE_LINUX="cryptdevice=/dev/sda2:root rootflags=subvol=@ rw quiet"
```
